...
/* A single statement may throw more than one type of exception. 
 * In such cases, Java allows you to put more than one catch blocks. 
 * One catch block handles one type of exception.  When an exception
 *  is thrown by the try block, all the catch blocks are examined in
 *   the order they appear and one catch block which matches with 
 *   exception thrown will be executed. After, executing catch block,
 *    program control comes out of try-catch unit.
 */
